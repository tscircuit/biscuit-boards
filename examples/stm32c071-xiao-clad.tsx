...
import { BM05B_SURS_TF, STM32C071FBP6 } from "./stm32c071-parts"
...
export const Stm32c071XiaoClad = (
  props: Pick<XiaoCladProps, "autorouter" | "routingDisabled"> = {},
) => (
  <XiaoClad nominalTraceWidth={0.15} {...props}>
...
export default () => <Stm32c071XiaoClad />
