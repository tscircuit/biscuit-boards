...
clearance holes sit 2.5 mm from the edges. Matching 10 mm x 2.8 mm via zones
run along the top and bottom edges, with no side zones. Each zone fits seven
columns and two rows. With the default 0.4 mm outer diameter and 1 mm
edge-to-edge clearance, the 1.4 mm center pitch produces 28 vias while leaving
a conservative 9.8 mm x 12.8 mm central component area open for chips and
sensors. The drill diameter is 0.3 mm.
...
<XiaoClad
  viaGridAreas={[
    { width: 10, height: 2.8, centerY: 8.4 },
    { width: 10, height: 2.8, centerY: -8.4 },
  ]}
  viaHoleDiameter={1}
...
connector on the newly open left side. All layer changes claim existing
prefabricated vias.
