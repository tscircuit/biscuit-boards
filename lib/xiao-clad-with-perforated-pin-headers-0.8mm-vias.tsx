...
export type XiaoCladWithPerforatedPinHeaders08mmViasProps =
  XiaoCladWithPinHeaders08mmViasProps

/** A XIAO clad whose header pads include perforations along both side edges. */
export const XiaoCladWithPerforatedPinHeaders08mmVias = ({
  markHeadersNoConnect = false,
  ...props
}: XiaoCladWithPerforatedPinHeaders08mmViasProps) => (
  <XiaoCladLayout
    {...props}
    boardName="XiaoCladWithPerforatedPinHeaders08mmVias"
    boardTitle="XIAO form-factor copper clad with perforated pin-header sides and 0.8 mm vias"
    pinHeaders={
